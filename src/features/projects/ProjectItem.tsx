    ...
    return (
        <div className="group relative bg-white dark:bg-slate-800/50 rounded-3xl overflow-hidden shadow-lg shadow-slate-200/50 dark:shadow-slate-900/50 border border-slate-100 dark:border-slate-700/50 hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-500 hover:-translate-y-2">
            <div className="relative h-70 overflow-hidden">
                <div className="absolute inset-0 z-10 bg-linear-to-t from-black/70 via-black/30 to-transparent opacity-100 can-hover:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-end p-4">
                    <a
                ...
                <img
                    className="w-full h-full object-cover transform transition-transform duration-500 ease-out lg:group-hover:scale-105"
